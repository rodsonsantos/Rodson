...
## 🚀 O que estou aprendendo (Database Stack)

Aqui estão as tecnologias e conceitos que estou explorando e praticando neste momento:
...
| **Curiosidade / Expansão** | Hugging Face (Estudando a aplicação de ML/NLP para análise de logs de database) |
